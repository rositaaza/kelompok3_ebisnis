...
<html>
	...
	<body style="background-color : #1ED7B5  !important">
	  	...
	  	<div id="main_body" class="container">
    		<div class="row">
    			<div class="col-md-8 margin-top50">
    				<h1 class="text-white font-80px text-center"><b>Get the best Risolles from Maragout</b></h1>   				
    			</div>
    			...
    			<div class="col-md-4 margin-top50">
    				...
    				<form class="form"  action="login_user.php" method="POST">
    					...
    					<input type="submit" class="btn-outline-secondary btn-lg btn-block" value="Login" name=""><br>
    				</form>
